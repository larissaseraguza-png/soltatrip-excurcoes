...
import { LayoutDashboard, Users, QrCode, Bus, MessageCircle, ArrowLeft, Bell, Shield } from "lucide-react";
        ...
        <div className="max-w-screen-md mx-auto px-5 py-4 flex items-center gap-3">
          ...
          {right ?? (
            <button className="size-10 grid place-items-center rounded-full glass relative">
              ...
              <span className="absolute top-2 right-2 size-2 rounded-full bg-neon-pink animate-pulse-glow" />
            </button>
          )}
        </div>
      </header>
